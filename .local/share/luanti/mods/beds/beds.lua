...
--		print("----", core.pos_to_string(pos), player:get_player_name())
		core.sound_play("default_dig_choppy", {pos = pos, gain = 0.5}, true)
	end
})
...
core.register_craft({type = "fuel", recipe = "beds:fancy_bed", burntime = 13})
core.register_craft({type = "fuel", recipe = "beds:fancy_bed_pink", burntime = 13})
core.register_craft({type = "fuel", recipe = "beds:bed", burntime = 12})
core.register_craft({type = "fuel", recipe = "beds:bed_blue", burntime = 12})
core.register_craft({type = "fuel", recipe = "beds:bed_white", burntime = 12})
